...
namespace MusicUnblock
{
    class MakeAutoStart
    {
        ...
        /// 快捷方式名称-任意自定义
        /// </summary>
        private const string QuickName = "MusicUnblock";
        ...
        public void SetMeAutoStart(bool onOff = true)
        {
            if (onOff)//开机启动
            {
                ...
                {
                    CreateShortcut(systemStartPath, QuickName, appAllPath, "网易云音乐代理解锁器");
                }
            }
            else//开机不启动
            {
        ...
        public void CreateDesktopQuick(string desktopPath = "", string quickName = "", string appPath = "")
        {
            ...
            {
                CreateShortcut(desktopPath, quickName, appPath, "开机解锁网易云音乐的启动项");
            }
        }
    }
}
